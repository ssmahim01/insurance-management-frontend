...
interface ClaimErrorStateProps {
  onRetry: () => void;
}

export function ClaimErrorState({ onRetry }: ClaimErrorStateProps) {
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-destructive/30 bg-destructive/5 py-16 px-6 text-center">
      ...
      <h3 className="text-base font-semibold text-foreground mb-1">Failed to load claims</h3>
