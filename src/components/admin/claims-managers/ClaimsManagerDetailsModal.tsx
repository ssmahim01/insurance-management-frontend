  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="min-w-0">
        ...
        <p
          className={`text-sm text-slate-800 dark:text-slate-200 wrap-break-word ${mono ? "font-mono" : ""}`}
        >
...
export function ClaimsManagerDetailsModal({ open, onOpenChange, item }: Props) {
  if (!item) return null;
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto p-0 [&::-webkit-scrollbar]:hidden scrollbar-none [-ms-overflow-style:none]">
        {/* Header */}
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Field
                ...
                label="Last Login"
                value={
                  item.lastLoginAt ? formatDate(item.lastLoginAt, true) : null
                }
              />
              <Field
                icon={Clock}
