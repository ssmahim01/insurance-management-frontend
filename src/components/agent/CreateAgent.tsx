...
//               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
//                 <div className="space-y-1.5">
//                   <Label htmlFor="a-division" className="text-xs font-semibold tracking-widest uppercase">
//                     Division
//                   </Label>
//                   <Input id="a-division" placeholder="e.g. Dhaka" {...register("division")} />
//                 </div>
//                 <div className="space-y-1.5">
//                   <Label htmlFor="a-district" className="text-xs font-semibold tracking-widest uppercase">
//                     District
//                   </Label>
//                   <Input id="a-district" placeholder="e.g. Dhaka" {...register("district")} />
//                 </div>
//                 <div className="space-y-1.5">
//                   <Label htmlFor="a-thana" className="text-xs font-semibold tracking-widest uppercase">
//                     Thana
//                   </Label>
//                   <Input id="a-thana" placeholder="e.g. Mirpur" {...register("thana")} />
//                 </div>
//                 <div className="space-y-1.5">
