...
export function UpdateAgentModal({
  ...
  useEffect(() => {
    if (open && item) {
      const leaderId =
        typeof item.agentLeader === "string"
          ? item.agentLeader
          : item.agentLeader?._id ?? "";
      ...
      reset({
        ...
        salaryPerCustomer: item.salaryPerCustomer
          ? Number(item.salaryPerCustomer)
          : undefined,
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 pt-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setValue("agentLeader", v as string, { shouldValidate: true })
                  }
                >
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="ua-salary" className="text-xs font-semibold tracking-widest uppercase">
                  Monthly Salary (BDT)
                </Label>
                <Input
                  id="ua-salary"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="ua-per-customer" className="text-xs font-semibold tracking-widest uppercase">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <Label htmlFor="ua-division" className="text-xs font-semibold tracking-widest uppercase">
                  Division
                </Label>
                <Input id="ua-division" placeholder="e.g. Dhaka" {...register("division")} />
              </div>
              <div className="space-y-1.5">
                <Label htmlFor="ua-district" className="text-xs font-semibold tracking-widest uppercase">
                  District
                </Label>
                <Input id="ua-district" placeholder="e.g. Dhaka" {...register("district")} />
              </div>
              <div className="space-y-1.5">
                <Label htmlFor="ua-thana" className="text-xs font-semibold tracking-widest uppercase">
                  Thana
                </Label>
                <Input id="ua-thana" placeholder="e.g. Mirpur" {...register("thana")} />
              </div>
              <div className="space-y-1.5">
