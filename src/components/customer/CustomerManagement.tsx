...
export default function CustomerManagement() {
    ...
    const [subscriptionsCustomer, setSubscriptionsCustomer] = useState<IUser | null>(null);
    ...
    const openSubscriptionsDialog = (c: IUser) => { setSubscriptionsCustomer(c); setIsSubscriptionsOpen(true); };
                                        ...
                                        <TableRow key={String(customer._id)} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
                                            ...
                                            <TableCell>
                                                <div className="flex gap-1.5 justify-end">
                                                    ...
                                                    <Button variant="outline" size="icon" className="h-8 w-8" title="View subscriptions" onClick={() => openSubscriptionsDialog(customer)}>
