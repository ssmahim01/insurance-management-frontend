      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto p-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 pt-1">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <Label htmlFor="uc-division" className="text-xs font-semibold tracking-widest uppercase">Division</Label>
                <Input id="uc-division" placeholder="e.g. Dhaka" {...register("division")} />
              </div>
              <div className="space-y-1.5">
                <Label htmlFor="uc-district" className="text-xs font-semibold tracking-widest uppercase">District</Label>
                <Input id="uc-district" placeholder="e.g. Dhaka" {...register("district")} />
              </div>
              <div className="space-y-1.5">
                <Label htmlFor="uc-thana" className="text-xs font-semibold tracking-widest uppercase">Thana</Label>
                <Input id="uc-thana" placeholder="e.g. Mirpur" {...register("thana")} />
              </div>
              <div className="space-y-1.5">
                <Label htmlFor="uc-union" className="text-xs font-semibold tracking-widest uppercase">Union / Ward</Label>
