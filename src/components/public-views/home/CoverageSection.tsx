...
//         }`}
//       >
//         <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-[#00C896]/10 px-4 py-1.5 dark:bg-[#00C896]/15">
...
//         <h3 className="mb-4 text-3xl font-bold text-[#0B1F3A] dark:text-white sm:text-4xl">
//           {block.title}
//         </h3>

//         <p className="mb-7 text-[15px] leading-relaxed text-gray-500 dark:text-gray-400 sm:text-base">
//           {block.description}
//         </p>

//         <Link
//           href={block.href}
//           className="group inline-flex items-center gap-2 rounded-full bg-[#007A55] px-6 py-3 text-sm font-semibold uppercase tracking-wide text-white transition-all duration-300 hover:bg-[#F97316]"
//         >
//           Know More
...
//       {/* Image column */}
//       <div
//         className={`relative h-64 w-full overflow-hidden rounded-2xl shadow-lg shadow-black/5 transition-all duration-700 ease-out dark:shadow-black/30 sm:h-80 lg:h-96 ${
...
//   return (
//     <section className="bg-white py-20 dark:bg-neutral-950 sm:py-24">
//       <div className="mx-auto max-w-7xl px-6">
//         <div
//           ref={headingRef}
//           className={`mx-auto mb-16 max-w-2xl text-center transition-all duration-700 ease-out sm:mb-20 ${
//             headingVisible
...
//             <CoverageRow key={block.id} block={block} />
//           ))}
//         </div>
//       </div>
//     </section>
